...
<head>
    <title>吃掉小阿银</title>
    <meta itemprop="name" content="吃掉小阿银" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        ...
        <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.reload()">主页</button>
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/balh55y/EatKano'">开源</button>
        </div>
    </div>
    </div>
            ...
            <div style="margin:0 8% 0 9%;">
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="吃掉小阿银">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
